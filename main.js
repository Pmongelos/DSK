// Symbol database
        const symbols = [
            { id: 'ta001', name: 'Kauri Tree', img: "", lat: -35.2760, lng: 173.5511, description: 'Ancient native tree of New Zealand', found: 'True'},
            { id: 'ta002', name: 'Mountain Peak', img: "", lat: -39.2920, lng: 176.3782, description: 'Highest point on the trail', found: 'False'}
        ];
      ...
      document.getElementById(tabId).classList.add('active');
        ...
        function renderSymbolList() {
            ...
            symbols.forEach(symbol => {
                ...
                `;
                if (symbol.found=='True'){container.appendChild(card);}
            });
        }